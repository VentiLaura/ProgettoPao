...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FilterWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FilterWidget_t qt_meta_stringdata_FilterWidget = {
    {
        QT_MOC_LITERAL(0, 12),  // "FilterWidget"
        QT_MOC_LITERAL(13, 13),  // "FilterChanged"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 12)   // "filterChosen"
    },
    "FilterWidget",
    "FilterChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_FilterWidget[] = {
...
Q_CONSTINIT const QMetaObject FilterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_FilterWidget.offsetsAndSizes,
    qt_meta_data_FilterWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_FilterWidget_t,
        // Q_OBJECT / Q_GADGET
...
void FilterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &FilterWidget::FilterChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterWidget::FilterChanged(const QString & _t1)
{
