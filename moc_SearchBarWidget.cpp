...
#include <memory>
#include "View/SearchBarWidget.h"
...
Q_CONSTINIT static const qt_meta_stringdata_SearchBarWidget_t qt_meta_stringdata_SearchBarWidget = {
    {
        ...
        QT_MOC_LITERAL(16, 15),  // "searchRequested"
        QT_MOC_LITERAL(32, 0),  // ""
...
void SearchBarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SearchBarWidget::searchRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchBarWidget::searchRequested(const QString & _t1)
{
